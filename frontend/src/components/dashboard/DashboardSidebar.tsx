...
export function DashboardSidebar() {
  return (
    <aside className="sidebar-surface flex w-64 shrink-0 flex-col gap-7 border-r border-border-field px-4 pt-7 pb-5">
      ...
      <nav aria-label="Navegación principal">
        ...
        <ul className="flex flex-col gap-1">
          <li>
            <SidebarNavItem to="/dashboard/roadmaps" icon={<RoutesIcon className="size-5" />}>
              Mis Rutas
            </SidebarNavItem>
          </li>
          <li>
