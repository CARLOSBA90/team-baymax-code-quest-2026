...
describe("PausedBanner", () => {
  ...
  it("añade el año si la pausa es de otro año", () => {
    renderWithProviders(
      <PausedBanner pausedAt="2025-09-03T12:00:00.000Z" descriptionId={DESCRIPTION_ID} />,
    );
  ...
  it("sin fecha de pausa válida solo muestra la segunda frase", () => {
    renderWithProviders(<PausedBanner pausedAt={null} descriptionId={DESCRIPTION_ID} />);
  ...
  it("una fecha inválida se trata como ausente", () => {
    renderWithProviders(<PausedBanner pausedAt="no-es-fecha" descriptionId={DESCRIPTION_ID} />);
